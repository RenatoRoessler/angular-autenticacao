...
import { switchMap, catchError, throttleTime, map, tap } from 'rxjs/operators';
  ...
  login(email: string, password: string): Observable<User> {
    ...
    return from(this.afAuth.auth.signInWithEmailAndPassword(email, password))
      .pipe(
        ...
        catchError(() => throwError('Usuário não regisrado ou senha incorreta'))
      )
  }
  logout() {
